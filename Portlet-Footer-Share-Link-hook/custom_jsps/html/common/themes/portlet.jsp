		...
		<c:choose>
			<c:when test="<%= portletDecorate %>">
				<liferay-theme:wrap-portlet page="portlet.jsp">
					...
					<c:if test="<%= facebookShowAddAppLink || iGoogleShowAddAppLink %>">
						<div class="portlet-section-footer">
							...
							<c:if test="<%= iGoogleShowAddAppLink %>">
								...
								<liferay-ui:icon
									...
									image="../social_bookmarks/igoogle-icon"
									label="<%= false %>"
									message="Aggiungi a iGoogle"
									url="<%= googleGadgetHREF %>"
									toolTip="Aggiungi a iGoogle"
								/>
							</c:if>
						</div>
					</c:if>

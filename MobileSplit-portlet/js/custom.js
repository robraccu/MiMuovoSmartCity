...
//Array Associativo che conterr� i parametri presenti
//in querystring
...
$("#mappa_page").live('pageinit',function(event){
		...
		var myOptions ={
		 ...
		 //Leggo i parametri
		  ...
		  if(show_fermatebusIcon=="true"){//controllo se � stato premuto nella home il pulsante "Bus"
		  ...
		  if(show_ciclopedpubIcon=="true"){//controllo se � stato premuto nella home il pulsante "Piste ciclabili"
		  ...
		  if(show_accessibilityIcon=="true"){//controllo se � stato premuto nella home il pulsante "Luoghi accessibili"
		  ...
		  if(show_taxiIcon=="true"){//controllo se � stato premuto nella home il pulsante "Postazioni Taxi"
			  show_taxiIcon=true;
		  	  show_trafficIcon=false;		  	  
		  }
		  else{
...
$("#mappa_page").live('pageshow',function(event){
	...
	}else if(routeArray.length>0){//se � presente un precedente percorso disegnato sulla mappa viene cancellato
...
//funzione richiamata sull'evonchange del men� di selezione dei layers
...
//al caricamento della pagina di default deve essere selezionata la modalit� driving

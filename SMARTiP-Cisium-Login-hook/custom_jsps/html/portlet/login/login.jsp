...
<!--
	document.write('<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1, maximum-scale=1.25, user-scalable=no" />');
	document.body.setAttribute('style','width:100%');
	
	//-->
</script>
<%-- ${themeDisplay.device.screenSize.width} ${themeDisplay.device.screenSize.height} --%>

<h1 id="welcome-login">Benvenuto</h1>
	...
	<c:otherwise>
		...
		<aui:form action="<%= loginURL %>" method="post" name="fm">
			...
			<aui:fieldset>
				...
				<h3 id="legend-login">Inserisci i tuoi dati per il login, oppure registrati.</h3>
